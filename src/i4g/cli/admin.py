...
def run_vertex_search(args: argparse.Namespace) -> None:
    ...
    if not data_store_id:
        console.print("[red]❌ --data-store-id is required.[/red]")
        sys.exit(1)
    ...
    if args.boost_json:
        try:
            ...
            console.print(f"[red]❌ Failed to parse --boost-json:[/red] {exc}")
            sys.exit(1)
    ...
    console.print(
        f"[cyan]🔍 Vertex search:[/cyan] project={project} location={location} data_store={data_store_id} query='{args.query}'"
    )
